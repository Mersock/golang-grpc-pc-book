...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x67, 0x6f, 0x6c, 0x61, 0x6e,
	0x67, 0x2e, 0x70, 0x63, 0x2e, 0x62, 0x6f, 0x6f, 0x6b, 0x1a, 0x14, 0x6d, 0x65, 0x6d, 0x6f, 0x72,
	...
	0x2e, 0x0a, 0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32,
...
var file_processor_message_proto_goTypes = []interface{}{
	(*CPU)(nil),    // 0: golang.pc.book.CPU
	(*GPU)(nil),    // 1: golang.pc.book.GPU
	(*Memory)(nil), // 2: golang.pc.book.Memory
}
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: golang.pc.book.GPU.memory:type_name -> golang.pc.book.Memory
