...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=golang.pc.book.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x63, 0x2e, 0x62, 0x6f, 0x6f, 0x6b, 0x22, 0xa1, 0x02, 0x0a, 0x06, 0x53, 0x63, 0x72, 0x65, 0x65,
	...
	0x28, 0x0b, 0x32, 0x21, 0x2e, 0x67, 0x6f, 0x6c, 0x61, 0x6e, 0x67, 0x2e, 0x70, 0x63, 0x2e, 0x62,
	...
	0x32, 0x1c, 0x2e, 0x67, 0x6f, 0x6c, 0x61, 0x6e, 0x67, 0x2e, 0x70, 0x63, 0x2e, 0x62, 0x6f, 0x6f,
	...
	0x12, 0x08, 0x0a, 0x04, 0x4f, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x42, 0x05, 0x5a, 0x03, 0x2f, 0x70,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: golang.pc.book.Screen.Panel
	(*Screen)(nil),            // 1: golang.pc.book.Screen
	(*Screen_Resolution)(nil), // 2: golang.pc.book.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: golang.pc.book.Screen.resolution:type_name -> golang.pc.book.Screen.Resolution
	0, // 1: golang.pc.book.Screen.panel:type_name -> golang.pc.book.Screen.Panel
